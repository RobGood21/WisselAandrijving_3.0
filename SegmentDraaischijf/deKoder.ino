...
const byte AantalActies = 11; //uiteindelijk nog bepalen
...
byte timercyclecount[2]; //teller voor het aantal doorlopen cycles
...
void SWon(byte _sw) {
	...
	case 1: //switch 2
		...
		case 9: //actie output Alarm
			...
			break;
		case 10: //actie timer 1
			TimerSwitch(_sw, 0);
			break;
		case 11: //actie timer 2
			TimerSwitch(_sw, 1);
			break;
